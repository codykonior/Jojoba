#
# Module manifest for module 'PSGet_Jojoba'
#
...
FunctionsToExport = 'Get-JojobaArgument', 'Out-JojobaSpeech', 'Publish-Jojoba', 
               'Start-Jojoba', 'Write-JojobaAbort', 'Write-JojobaFail', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'PoshRSJob','Runspace','RunspacePool','PowerShellCore','RSJob','Jenkins','Jojoba','Testing','PSEdition_Desktop','PSEdition_Core'
